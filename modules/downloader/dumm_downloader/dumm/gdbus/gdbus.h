...
#ifdef __cplusplus
#define GDBUS_METHOD_EMPTY() \
	NULL, NULL, G_DBUS_METHOD_FLAG_EMPTY, 0, NULL, NULL


#define GDBUS_METHOD(_name, _in_args, _out_args, _function) \
	 _name, \
	_function, \
	G_DBUS_METHOD_FLAG_EMPTY, \
	0, \
	_in_args, \
	_out_args 
#else
...
#define GDBUS_SIGNAL(_name, _args) \
	_name, G_DBUS_SIGNAL_FLAG_EMPTY, _args

#define GDBUS_DEPRECATED_SIGNAL(_name, _args) \
	_name, G_DBUS_SIGNAL_FLAG_DEPRECATED, _args

#define GDBUS_EXPERIMENTAL_SIGNAL(_name, _args) \
	_name, G_DBUS_SIGNAL_FLAG_EXPERIMENTAL, _args

#define GDBUS_SIGNAL_EMPTY() \
	NULL, G_DBUS_SIGNAL_FLAG_EMPTY, NULL
